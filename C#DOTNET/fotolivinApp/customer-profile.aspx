<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true"
    CodeFile="customer-profile.aspx.cs" Inherits="customer_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
        ...
        <a class="example-image-link" href='<%#Eval("customerCoverImgPath1") %>' data-lightbox="example-set">
                      ...
                      <div class="row">
                          <div class="form-panel">
                              <h4 class="mb">
                                  <i class="fa fa-edit"></i> Change Customer's Profile and Cover Photo <a style="color:Black;" data-toggle="modal" href="#myModal4"><img src="images/info.png"/ width="15" height="15"></a></h4>
                              <div class="form-horizontal style-form">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                         Choose profile image : </label>
                                      <div class="col-sm-10">
                        <asp:FileUpload ID="uploadcustomerprofimg" class="form-control" runat="server" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                      ...
                                      <div class="col-sm-10">
                        <asp:FileUpload ID="uploadcustomercoverimg" class="form-control" runat="server" />
                                      </div>
                      ...
                      <div class="row">
                          <div class="form-panel">
                              <h4 class="mb">
                                  <i class="fa fa-edit"></i> Edit Customer Profile Information <a style="color:Black;" data-toggle="modal" href="#myModal5"><img src="images/info.png"/ width="15" height="15"></a></h4>
                              <div class="form-horizontal style-form">
                              <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          Company ID :</label>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          Customer Name :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomernametb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                      ...
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editsecondnametb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          Email ID :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomeremailtb" MaxLength="45" class="form-control" runat="server" TextMode="Email"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          Phone :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomerphonetb" MaxLength="15" class="form-control" runat="server" TextMode="Phone" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          City :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomercitytb" MaxLength="45"  class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          State :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomerstatetb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">
                                          Country :</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="editcustomercountrytb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                  ...
                  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal5" class="modal fade">
		              <div class="modal-dialog">
						...
						<center>
						<div class="form-panel">
                        <h4 class="mb"><i class="fa fa-edit"></i>  Edit customer's or account's details in app</h4>
    ...
    <script type = "text/javascript">
        $(window).load(
    function () {
        $("#<%=uploadcustomerprofimg.ClientID%>").fileUpload({
            'uploader': 'scripts/uploader.swf',
            'cancelImg': 'images/cancel.png',
            'buttonText': 'Choose File..!!',
            'script': 'uploadcustomerprofimg.ashx',
            'folder': 'uploads',
            'fileDesc': 'Image Files',
            'fileExt': '*.jpg;*.jpeg;*.JPG;*.JPEG',
            'scriptData': { "coid": "<%=editcompanyidlbl.Text%>", "customerid": "<%=editcustomeridlbl.Text%>" },
            'multi': false,
            'auto': true
...
<script type = "text/javascript">
    $(window).load(
    function () {
        $("#<%=uploadcustomercoverimg.ClientID%>").fileUpload({
            'uploader': 'scripts/uploader.swf',
            'cancelImg': 'images/cancel.png',
            'buttonText': 'Choose File..!!',
            'script': 'uploadcustomercoverimg.ashx',
            'folder': 'uploads',
            'fileDesc': 'Image Files',
            'fileExt': '*.jpg;*.jpeg;*.JPG;*.JPEG',
            'scriptData': { "coid": "<%=editcompanyidlbl.Text%>", "customerid": "<%=editcustomeridlbl.Text%>" },
