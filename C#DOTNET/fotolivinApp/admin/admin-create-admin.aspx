<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin-menu.master" AutoEventWireup="true" CodeFile="admin-create-admin.aspx.cs" Inherits="admin_create_admin" %>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="row mtbox" style="margin-top:40px;">
                        ...
                        <h4 class="mb"><i class="fa fa-edit"></i> Create New Admin Account</h4>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="phonetb" MaxLength="45" class="form-control" runat="server" TextMode="Phone"></asp:TextBox>
                              </div>
                          </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="passwordtb" MaxLength="15" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                            <div class="form-group">
