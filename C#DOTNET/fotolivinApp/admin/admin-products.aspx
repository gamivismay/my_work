<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin-menu.master" AutoEventWireup="true" CodeFile="admin-products.aspx.cs" Inherits="admin_products" %>
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart" style="width: 100%;">
                      ...
                      <asp:Panel ID="addpnl" runat="server">
                       <div class="row mtbox"  style="margin-top:40px; margin-bottom:0px;">
                          <div class="form-panel">
                              <h4 class="mb">
                                  <i class="fa fa-edit"></i>Add new product..!!</h4>
                              <div class="form-horizontal style-form" >
                               <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Choose company ID:</label>
                                      <div class="col-sm-10">
                                          <asp:DropDownList ID="companyidlist" class="form-control" runat="server" 
                                              DataSourceID="SqlDataSource1" DataTextField="companyid" 
                                              DataValueField="companyid">
                                          </asp:DropDownList>
                                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                              ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                              SelectCommand="SELECT [companyid] FROM [companydetails]">
                                          </asp:SqlDataSource>
                                      </div>
                                  </div>
                              <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Product Name:</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="productnametb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Product Size:</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="productsizetb" MaxLength="15" class="form-control" runat="server"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Product Price:</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="productpricetb" MaxLength="15" class="form-control" runat="server"></asp:TextBox>
                                      </div>
                                  </div>
                      ...
                      RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle"
                              ...
                              CellSpacing="3" ForeColor="Black" onrowdatabound="GridView2_RowDataBound" PageSize="50">
                      ...
                      <Columns>
                          ...
                          </asp:TemplateField>                                                                                                     <asp:BoundField DataField="companyid" HeaderText="Company ID" /> 
...
<RowStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="White"></RowStyle>
                             ...
                             <center>
                              <h4 class="mb" style="text-decoration: underline;">
                                  ...
                                  <a class="example-image-link" href='<%#Eval("imagePath1") %>' data-lightbox="example-set">
                                     ...
                                     <p> CompanyID: 
                                              <asp:Label ID="companyidlbl" runat="server" Text='<%#Eval("companyid1") %>'></asp:Label></p>
                                          <p>
                                          ProductID: 
            ...
            CommandArgument='<%#Eval("productid1") %>' ForeColor="Red">Delete</asp:LinkButton>
                      ...
                      <div class="row"  style="margin-top:40px; margin-bottom:0px;">
                          <div class="form-panel">
                              <h4 class="mb">
                                  <i class="fa fa-edit"></i> View details</h4>
                              <div class="form-horizontal style-form">
                               <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;" >
                                          Company ID:</label>
