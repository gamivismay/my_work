<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin-menu.master" AutoEventWireup="true" CodeFile="admin-create-account.aspx.cs" Inherits="admin_create_account" %>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="row mtbox" style="margin-top:40px;">
                        ...
                        <h4 class="mb"><i class="fa fa-edit"></i> Create New Company Account</h4>
                        <div class="form-horizontal style-form">
                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Full Name :</label>
                              <div class="col-sm-10">

                                  <asp:TextBox ID="fullnametb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="companynametb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="addresstb" MaxLength="495" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="citytb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="statetb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="countrytb" MaxLength="45" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>

                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">SMS credit :</label>
                              <div class="col-sm-10">

                                  <asp:TextBox ID="smscredittb" MaxLength="15" class="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
