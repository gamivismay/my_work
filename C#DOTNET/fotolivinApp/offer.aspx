<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true" CodeFile="offer.aspx.cs" Inherits="offer" %>
                          ...
                          <div class="form-panel">
                              ...
                              <div class="form-group" style="width:100%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Ad Name:</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="adnametb" class="form-control" MaxLength="95" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="form-group" style="width:100%;  margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Ad Details:</label>
                                      <div class="col-sm-10">
                                          <asp:TextBox ID="addetailtb" class="form-control" MaxLength="495" runat="server"  onkeypress="javascript:return isNumber2(event)"></asp:TextBox>
                                      </div>
                                  </div>
