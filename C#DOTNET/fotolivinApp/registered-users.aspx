<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true" CodeFile="registered-users.aspx.cs" Inherits="registered_users" %>
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart" style="width: 100%;">
                      ...
                      RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle"
                              ...
                              CellSpacing="3" ForeColor="Black" onrowdatabound="GridView2_RowDataBound" PageSize="100">
                              ...
                              <div class="form-group" style="width:48%; float:left; margin:0%;">
                                  ...
                                  <div class="form-group" style="width:100%; float:left; margin:0%;">
                                   ...
                                   <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Pincode:</label>
                                      <div class="col-sm-10">
                                          <asp:Label ID="editpincodelbl"  runat="server"></asp:Label>
                                      </div>
                                  </div>
                                  <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                  ...
                                  <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Account Name:</label>
                                      <div class="col-sm-10">
                                          <asp:Label ID="editaccountnamelbl"  runat="server"></asp:Label>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group" style="width:100%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
                                          Device Token:</label>
                                      <div class="col-sm-10">
                                          <asp:Label ID="editdevicetokenlbl"  runat="server"></asp:Label>
                                      </div>
                                  </div>
                                  <div class="form-group" style="width:48%; float:left; margin:0%;">
                                      <label class="col-sm-2 col-sm-2 control-label" style="padding:0%;">
