...
public partial class service : System.Web.UI.Page
{
    ...
    protected void addbtn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dtcheck.Rows.Count == 0)
            {
                ...
                string exploreImage = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "service" + "\\" + eventnamelist.Text;
                ...
                foreach (HttpPostedFile uploadedFile in FileUpload1.PostedFiles)
                {
                    ...
                    {
                        string companyservicepath = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "service" + "\\" + eventnamelist.Text + "\\" + filename;
                    ...
                    {
                        Page.RegisterStartupScript("UserMsg", "<script>alert('Please upload a image..! or Check file format..! Only .jpg and .png is allowed.');if(alert){ window.location='service';}</script>");
                ...
                string s1 = "insert into service values('" + coid1 + "','" + eventnamelist.Text + "','" + startingcost.Text + "','" + Paymentterms.Text + "','" + travelcost.Text + "')";
                    ...
                    cmd.ExecuteNonQuery();
                    Page.RegisterStartupScript("UserMsg", "<script>alert('Upload complete..!');if(alert){ window.location='service';}</script>");
            ...
            {
                Page.RegisterStartupScript("UserMsg", "<script>alert('Service already exists. Please edit service in details.');if(alert){ window.location='service';}</script>");
    ...
    protected void viewdetails_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            ...
            while (dr.Read())
            {
                ...
                string exploreImage = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "service" + "\\" + editservicename.Text;
        ...
        catch (Exception ex)
        {
            ...
            Page.RegisterStartupScript("UserMsg", "<script>alert('Failed. Try again later');if(alert){ window.location='service';}</script>");
    ...
    protected void updateinfobtn_Click(object sender, EventArgs e)
    {
        if (FileUpload2.HasFile)
        {
            ...
            foreach (HttpPostedFile uploadedFile1 in FileUpload2.PostedFiles)
            {
                ...
                if (fileext == ".jpg" || fileext == ".JPG" || fileext == ".jpeg" || fileext == ".JPEG" || fileext == ".png" || fileext == ".PNG")
                {
                    string companyservicepath = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "service" + "\\" + editservicename.Text + "\\" + filename;
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                Page.RegisterStartupScript("UserMsg", "<script>alert('Service updated..!');if(alert){ window.location='service';}</script>");
    ...
    protected void deletebtn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string exploreImage = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "service" + "\\" + servicename;
            ...
            try
            {
                ...
                Page.RegisterStartupScript("UserMsg", "<script>alert('Images deleted..!');if(alert){ window.location='service';}</script>");
        ...
        try
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    bindExploreDetails();
                    Page.RegisterStartupScript("UserMsg", "<script>alert('Service deleted..!');if(alert){ window.location='service';}</script>");
