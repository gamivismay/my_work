...
public partial class explore : System.Web.UI.Page
{
    ...
    public void viewsDetails()
    {
        ...
        
        {
            ...
            catch (Exception ex)
            {
                ...
                Page.RegisterStartupScript("UserMsg", "<script>alert('Failed. Try again later');if(alert){ window.location='dashboard';}</script>");
    ...
    protected void addbtn_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            string coid1 = Session["coid"].ToString();
            string exploreImage = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "explore" + "\\" + "photo";
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                Page.RegisterStartupScript("UserMsg", "<script>alert('Upload complete..!');if(alert){ window.location='explore';}</script>");
        ...
        {
            Page.RegisterStartupScript("UserMsg", "<script>alert('Please upload a image..!');if(alert){ window.location='explore';}</script>");
    ...
    protected void updateinfobtn_Click(object sender,   EventArgs e)
    {
        if (FileUpload2.HasFile)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                Page.RegisterStartupScript("UserMsg", "<script>alert('Photo updated..!');if(alert){ window.location='explore';}</script>");
        ...
        
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string imagePath = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "explore" + "\\" + "photo";
    ...
    protected void Repeater2_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "delete")
        {
            ...
            try
            {
                ...
                string imagePath = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "explore" + "\\" + "photo" + "\\" + fullname;
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        displayEvents();
                        Page.RegisterStartupScript("UserMsg", "<script>alert('Date deleted..!');if(alert){ window.location='explore';}</script>");
        ...
        if (e.CommandName == "edit")
        {
            ...
            catch (Exception ex)
            {
                ...
                Page.RegisterStartupScript("UserMsg", "<script>alert('Failed. Try again later');if(alert){ window.location='explore';}</script>");
    ...
    //        string exploreImage = System.Configuration.ConfigurationManager.AppSettings["companyDataPath"] + coid1 + "\\" + "explore" + "\\" + "photo" + "\\" + filename + ext;
