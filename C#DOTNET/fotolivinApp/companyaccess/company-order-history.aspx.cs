...
public partial class company_order_history : System.Web.UI.Page
{
    ...
    protected void updateinfobtn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            con.Open();
            cmd.ExecuteNonQuery();
            Page.RegisterStartupScript("UserMsg", "<script>alert('Updated..!!');if(alert){ window.location='company-order-history';}</script>");
    ...
    //        catch (Exception ex)
    //        {
    //            Page.RegisterStartupScript("UserMsg", "<script>alert('No internet connection. Try again later');if(alert){ window.location='company-order-history';}</script>");
    ...
    //                            Page.RegisterStartupScript("UserMsg", "<script>alert('sms sent..!!');if(alert){ window.location='company-order-history';}</script>");
    ...
    //                        ex2 = ex2.InnerException;
    //                    }
    //                    Page.RegisterStartupScript("UserMsg", "<script>alert('Sending Failed. Check Your internet connection. Try again later or contact your operator');if(alert){ window.location='company-order-history';}</script>");
    ...
    //            else
    //            {
    //                Page.RegisterStartupScript("UserMsg", "<script>alert('Phone Number not valid. Try again later or contact your operator');if(alert){ window.location='company-order-history';}</script>");
    ...
    //    else
    //    {
    //        Page.RegisterStartupScript("UserMsg", "<script>alert('Phone Number not valid. Try again later');if(alert){ window.location='company-order-history';}</script>");
