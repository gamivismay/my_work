<%@ Page Title="" Language="C#" MasterPageFile="~/companyaccess/company-menu.master" AutoEventWireup="true" CodeFile="company-order-history.aspx.cs" Inherits="company_order_history" %>
              ...
              <div class="row">
                  ...
                  <div class="row mt">
                      ...
                      <div class="form-panel">
						  <h4><i class="fa fa-angle-right"></i> All Order Details <a style="color:Black;" data-toggle="modal" href="#myModal1"><img src="images/info.png"/ width="15" height="15"></a></h4>
...
<RowStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="White"></RowStyle>
                     ...
                     <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal1" class="modal fade">
		              <div class="modal-dialog">
						...
						<center>
						<div class="form-panel">
                        <h4 class="mb"><i class="fa fa-edit"></i> View all orders placed by users via app</h4>
                        <h4 class="mb"><i class="fa fa-edit"></i> View all details of particular order and update its status</h4>
					...
					<div class="row">
                     <div class="form-panel">
                              <h4 class="mb">
                                  <i class="fa fa-edit"></i> View & Edit order details <a style="color:Black;" data-toggle="modal" href="#myModal2"><img src="images/info.png"/ width="15" height="15"></a></h4>
                       ...
                       <div class="form-panel">
                        ...
                        <div class="form-group">
                                      ...
                                      <div class="col-sm-10" style="width:100%;">
                                          <asp:TextBox ID="msgtexttb" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                      </div>
                                  </div>
                              
                                  <div class="form-group">
                                      <div class="col-sm-10" style="width:100%;">
                                      <asp:Button ID="sendsmsbtn" class="btn btn-default" runat="server" Text="Send" onclick="sendsmsbtn_Click"
                                          />
                                           </div>
                                  </div>
                                </center>
                  ...
                  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal2" class="modal fade">
		              <div class="modal-dialog">
						...
						<center>
						<div class="form-panel">
                        <h4 class="mb"><i class="fa fa-edit"></i> Edit order details and status for app</h4>
                        
                        <div class="form-horizontal style-form">
                         <div class="form-group">
                            
                            <img src="images/order2.png" style="width:100%; height:auto;"/>
