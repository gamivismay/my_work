<%@ Page Title="" Language="C#" MasterPageFile="~/companyaccess/company-menu.master" AutoEventWireup="true" CodeFile="company-company-profile.aspx.cs" Inherits="company_company_profile" %>
                         ...
                         <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:Label ID="editsampleaccountidlbl" MaxLength="45" PlaceHolder="Sample account id" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:Label>
                              </div>
                          </div>
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editfullnametb" MaxLength="45" class="form-control" PlaceHolder="fullname" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editcompanynametb" MaxLength="45" class="form-control" PlaceHolder="company name" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editpasswordtb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editcitytb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editstatetb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editcountrytb" MaxLength="45" class="form-control" runat="server" onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editfblinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editinstagramlinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editgooglepluslinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="edittwitterlinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="edityoutubelinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <asp:TextBox ID="editwebsitelinktb" MaxLength="150" class="form-control" runat="server" TextMode="Url"></asp:TextBox>
                              </div>
                          </div>
                           <div class="form-group">
