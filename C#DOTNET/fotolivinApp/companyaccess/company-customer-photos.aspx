<%@ Page Title="" Language="C#" MasterPageFile="~/companyaccess/company-menu.master" AutoEventWireup="true" CodeFile="company-customer-photos.aspx.cs" Inherits="company_customer_photos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" Runat="Server">
    ...
    <div class="form-panel">
                          ...
                          <h4 class="mb">
                                  <i class="fa fa-edit"></i> View Photo Gallery <a style="color:Black;" data-toggle="modal" href="#myModal2"><img src="images/info.png"/ width="15" height="15"></a>
                                 </h4>
         ...
         <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal2" class="modal fade">
		              <div class="modal-dialog">
						...
						<center>
						<div class="form-panel">
                        <h4 class="mb"><i class="fa fa-edit"></i> photo galleries for APP</h4>
