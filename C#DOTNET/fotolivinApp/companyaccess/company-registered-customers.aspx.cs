...
public partial class company_registered_customers : System.Web.UI.Page
{
   ...
   //uncomment this two codes to give access of delete template field to company and add delete linkbutton with rowdatabound and bind customerid
    ...
    //        string eventsPath = System.Configuration.ConfigurationManager.AppSettings["customerDataPath1"] + companyid + "\\" + customerid;
