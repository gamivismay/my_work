<%@ Page Title="" Language="C#" MasterPageFile="~/companyaccess/company-menu.master" AutoEventWireup="true" CodeFile="company-dashboard.aspx.cs" Inherits="company_dashboard" %>
      ...
      <section id="main-content">
        ...
        <a class="example-image-link" href='<%#Eval("companyCoverImgPath1") %>' data-lightbox="example-set">
                                 ...
                                 <div class="pr2-social centered">
									<h4>
                                     <a style="color:Black;" href="company-company-profile"> View/Edit Company Profile</a>
		                           </h4>
								</div>
                              </div>
						...
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<div class="row">
                                          ...
                                          <div class="pr2-social centered">
									<h4>
                                     <a style="color:Black;" href="company-registered-users">View all users >>></a>
		                           </h4>
								</div>
