...
public partial class company_customer_profile : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            Page.RegisterStartupScript("UserMsg", "<script>alert('Failed. Try again later. If still problem persist than contact admin');if(alert){ window.location='company-registered-customers';}</script>");
    ...
    {
        string customerProfImgPath = System.Configuration.ConfigurationManager.AppSettings["customerDataPath1"] + editcompanyidlbl.Text + "\\" + editcustomeridlbl.Text + "\\" + "profileimage";
    ...
    {
        string customerCoverImgPath = System.Configuration.ConfigurationManager.AppSettings["customerDataPath1"] + editcompanyidlbl.Text + "\\" + editcustomeridlbl.Text + "\\" + "coverimage";
    ...
    protected void sendsmsbtn_Click(object sender, EventArgs e)
    {
        ...
        string url = "company-customer-profile";
                try
                {
