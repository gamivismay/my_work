...
public partial class company_company_profile : System.Web.UI.Page
{
    ...
    protected void photobtn_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("company-service");
        }
        catch (Exception ex)
        {
            Exception ex2 = ex;
    ...
    {
        Response.Redirect("company-company-profile");
    }
}