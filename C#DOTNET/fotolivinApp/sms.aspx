<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true" CodeFile="sms.aspx.cs" Inherits="sms" %>
                        ...
                        <div class="form-horizontal style-form">
                         <div class="form-group">
                              ...
                              <div class="col-sm-10" style="width:30%;">
                                  ...
                                  <asp:TextBox ID="numbertb" class="form-control" runat="server" placeholder="(for multiple sms, numbers should be separated with comma, eg:123456789, 987654321)" TextMode="MultiLine" Height="80px"></asp:TextBox>
                              </div>
                          </div>
                          <div class="form-group">
