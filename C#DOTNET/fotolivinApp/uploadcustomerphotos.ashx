...
public class Upload : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            string eventphotos = System.Configuration.ConfigurationManager.AppSettings["customerDataPath"] + companyid + "\\" + customerid + "\\" + "photos" + "\\" + eventname;
            Directory.CreateDirectory(context.Server.MapPath(eventphotos));
            ...
            string SaveAsImage = System.IO.Path.Combine(context.Server.MapPath(eventphotos + "/" + customerid + eventname + imageName + originalname + ext));
            postedFile.SaveAs(SaveAsImage);
            string finalimagename = customerid + eventname + imageName + originalname;
            string s1 = "insert into photodetails values('"+companyid+"','"+customerid+"','"+ "photos" +"','"+eventname+"','"+originalname+"','"+finalimagename+"','"+size+"','"+ext+"','"+ "0" +"','"+ "0" +"')";
            ...
            context.Response.Write(eventphotos + "/" + filename);
